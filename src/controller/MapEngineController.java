...
public class MapEngineController {
    ...
    public static final String INCORRECT_COMMAND = "Please enter a proper command";
    ...
    public ResponseWrapper getMainMapCommandsFromUser() throws GeneralException {
        ...
        if (l_userEnteredMainMapCommands.trim().isEmpty()) {
            ...
            return new ResponseWrapper(404, INCORRECT_COMMAND); // nothing entered, please enter a proper command
        }
        ...
        switch (l_splitMainMapCommand[0]) {
            ...
            case "exit":
                ...
                return new ResponseWrapper(204, "Return from the current command");
            default:
                return new ResponseWrapper(404, INCORRECT_COMMAND); // nothing entered, please enter a proper command
        }
    }
